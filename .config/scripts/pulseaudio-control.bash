...
VOLUME_ICONS=( "%{T3} %{T1}" "%{T3} %{T1}" "%{T3} %{T1}" "%{T3} %{T1}" )
MUTED_ICON="%{T3} %{T1}"  # Muted volume icon
MUTED_COLOR="%{F#59ffffff}"  # Color when the audio is muted
...
SINK_NICKNAMES["alsa_output.pci-0000_00_1f.3.analog-stereo/analog-output-speaker"]="%{T3}%{T1} Speakers"
SINK_NICKNAMES["alsa_output.pci-0000_00_1f.3.analog-stereo/analog-output-headphones"]="%{T3}%{T1} Headphones"
